...
<div id="content-header">
	<div id="breadcrumb">
		...
		<a href="restoran.php" title="Go to Restoran" class="tip-bottom"><i class="icon-coffee"></i>Restoran</a>
		<a class="current"><i class="icon-book"></i>Detail</a>
	</div>
    <h1> </h1>
    <a style="margin-left:25px" href="restoran.php" class="btn btn-success"><i class="icon-home"></i>&nbsp Kembali</a>
</div>
  ...
  <div class="row-fluid">
      <!--PERTAMA-->
      	<div class="widget-box">
            	...
            	<h5>Detail Restoran "<?php echo $restoran;?>"</h5>
          	</div>
			...
			<form method="post" class="form-horizontal">
		    	<div class="control-group">
          		<label class="control-label">Nama Restoran  :</label>
          			<div class="controls">
            		<input type="text" readonly class="span10" value="<?php echo $restoran;?>" />
          			</div>
        		</div>
        		<div class="control-group">
