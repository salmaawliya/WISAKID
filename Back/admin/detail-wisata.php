...
<div id="content-header">
	<div id="breadcrumb">
		...
		<a href="wisata.php" title="Back to Wisata" class="tip-bottom"><i class="icon-shopping-cart"></i> Wisata</a>
      ...
      <!--PERTAMA-->
      	...
      	<div class="widget-box">
          	...
          	<div class="controls">
				...
				$g3 = $data["g3"];
				$g4 = $data["g4"];
				echo "<td><img src='../img/$g1' /></td>";
				echo "<td><img src='../img/$g2' /></td>";
				echo "<td><img src='../img/$g3' /></td>";
				echo "<td><img src='../img/$g4' /></td>";
				echo "</tr>";
				}
				?>
				</table>
