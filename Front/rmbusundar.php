...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('../Back/img/rumahmakan_busundar.jpg');">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p><h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Rumah Makan Jawa Bu Sundar</h1></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card"></div>
        ...
        <div class="card-body">
            <?php
                $sql = mysqli_query($con, "SELECT * FROM tbrestoran WHERE tbrestoran.kdrestoran=9");
            ...
            <tr>
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15805.639805803527!2d110.6036527!3d-7.9565174!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x20368a88cd529f5c!2sRM%20Jawa%20%22Bu%20Sudar%22!5e0!3m2!1sid!2sid!4v1672710861581!5m2!1sid!2sid" 
                  width="250" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </td><br><br>
                <td><b>Reservasi:</b> 0813-2648-1879
                </td>
